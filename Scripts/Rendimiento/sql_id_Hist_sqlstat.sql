-- The query mines the AWR tables (beware the licence implications) for a specific SQL ID 
-- and date/time range and shows a few choice statistics for each snapshot period
-- https://oraganism.wordpress.com/2011/12/14/a-dba_hist_sqlstat-query-that-i-am-very-fond-of/
